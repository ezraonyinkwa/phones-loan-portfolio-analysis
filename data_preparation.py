...
#Hard to use since no Income section in the credit dataset and the customer income dataset is not linked to the credit dataset by any common identifier.
